    ...
    <div class="container-fluid  bg-dark">
      ...
      <div class="row">
        <div class="info  text-light">
          ...
          <div class="timer pr-2  pb-5 float-end mb-5"> <i class="fa fa-clock-o" aria-hidden="true"></i>Time left: <span
              id="timer"> 1:30:00</span>
          </div>
...
-->
          <form onsubmit="return sub()" action="../submit/proccess.php?questions=<?php echo $totalq ?>" method="post">
            ...
            foreach ($combine_subject as $key => $subjects) {
              ...
              foreach ($subjects as $index => $question) {
                ...
                <div class="questions  mySlides  conatiner  pt-2 bg-dark  ">
                  ...
                  <h5 id="" class="text-light  float-left "> <?php echo '[' . $index + 1 . ']    ' . $question['question_text'] ?>
                  </h5>
                  <?php
                  ...
                  for ($i = 1; $i <= 4; $i++) {
                    ...
                    <div class="cover column bg-dark text-light">
                      ...
                      <h5> <input onclick=" handlestate('<?php echo $question['subject'] ?><?php echo $index + 1 ?>')" type="radio"
                          class="bg-dark text-white" name=" <?php echo $question['question_id'] ?>" id="<?php echo $optionid ?>"
                          value="<?php echo $i ?>">
            ...
            <button id="form" name="submit" class=" btn  col-2 mt-2 m-5    btn-lg btn-danger"
