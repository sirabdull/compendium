...
$db = getDbInstance();
$select = array('id', 'fullname', 'email', 'mobile', 'subscribed', 'subscription_type', 'reg_date', 'verification');
...
$rows = $db->arraybuilder()->paginate('registerd_candidates', $page, $select);
...
?>>Desc</option>
    ...
    <table class="table table-striped table-bordered table-condensed">
        <thead>
            <tr>
                <th width="5%">ID</th>
                <th width="45%">fullName <i class="fa fa-user-circle" aria-hidden="true"></i></th>
                <th width="20%">email <i class="fa fa-envelope" aria-hidden="true"></i></th>
                <th width="20%">mobile <i class="fa fa-mobile" aria-hidden="true"></i></th>
                <th width="20%">subscribed <i class="fa fa-check" aria-hidden="true"></i></th>
                  <th width="20%">Verified <i class="fa fa-check" aria-hidden="true"></i></th>
                <th width="20%">subscription_type <i class="fa fa-check-circle" aria-hidden="true"></i></th>
                <th width="20%">Registerd_date <i class="fa fa-calendar" aria-hidden="true"></i></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo  $row['subscription_type'] ;?>
