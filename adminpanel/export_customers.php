...
$db = getDbInstance();
$select = array('id', 'fullname', 'email', 'mobile', 'subscribed', 'subscription_type', 'reg_date');


$chunk_size = 100;
$offset = 0;

$data = $db->withTotalCount()->get('registerd_candidates');
...
for ($i=0; $i<$num_queries; $i++){
    ...
    $rows = $db->get('registerd_candidatesa4WWER1',Array($offset,$chunk_size), $select);
