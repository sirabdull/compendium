...
$db = getDbInstance();
$select = array('id',  'email',  'subscription_type', 'subscription_date', 'expiry_date', 'reference');
...
$rows = $db->arraybuilder()->paginate('subscribed_candidates', $page, $select);
    ...
    <table class="table table-striped table-bordered table-condensed">
        <thead>
            <tr>
                ...
                <th width="20%">subscription_type </th>
                <th width="20%">subscription_date </th>
                <th width="20%">Expiry_date </th>
                <th width="20%">Reference 
        ...
        <tbody>
            ...
            <div class="modal fade" id="confirm-delete-<?php echo $row['id']; ?>" role="dialog">
                <div class="modal-dialog">
                    <form action="delete_subscribed.php" method="POST">
                        <!-- Modal content -->
